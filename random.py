...
#let us load and read the csv file and visualize it through a dataframe and a vertical segmented bar chart 
    data3=pd.read_csv("Suiciderates.csv")
    data3.reset_index()
...
#Loading the csv file and reading it 
    data4=pd.read_csv("AgeStandardizedSuicideRate.csv")
    data4.reset_index()
...
#Loading and reading the data  
    data5=pd.read_csv("AgeStandardizedSuicideRateLEB.csv") #age standardized Suicide Rate per 100 000 population for gender 
...
with dataExploration4:
    ...
    st.text('This dataset is found in the Global Health Observatory database at WHO website.')
#Loading and reading the data
    data1=pd.read_csv('MentalHealthGovernanceClean.csv')
    #st.write(data1)
...
#Loading and reading the data 
    data2=pd.read_csv('HRMentalHealth.csv')
    #st.write(data2)
